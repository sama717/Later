...
import { ArrowLeft, Star, ChevronLeft, ChevronRight, Play } from "lucide-react";
import {
  FaPlaystation,
  FaXbox,
  FaLaptop,
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 pt-8 pb-40 bg-background text-foreground min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full mb-8">
        ...
        <button className="bg-primary text-primary-foreground py-4 px-8 w-96 font-semibold hover:opacity-90 cursor-pointer transition-opacity">
          Add to Library
        </button>
      </div>
          ...
          {trailers.length > 0 && (
            <div className="flex flex-wrap gap-3 pt-1">
              <button
                ...
                className={`relative w-30 h-30 bg-secondary border overflow-hidden cursor-pointer transition-colors ${
                  !activeVideoUrl
                    ? "border-foreground"
      ...
      {lightboxIndex !== null && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4 select-none">
          ...
          <button
            ...
            className="absolute left-6 text-white hover:text-muted-foreground z-10 p-3 bg-black/50 cursor-pointer"
          >
            <ChevronLeft size={24} />
          </button>

          <div className="relative max-w-5xl max-h-[80vh] overflow-hidden bg-black">
            <img
          ...
          <button
            ...
            className="absolute right-6 text-white hover:text-muted-foreground z-10 p-3 bg-black/50 cursor-pointer"
          >
          ...
          <button
            onClick={() => setLightboxIndex(null)}
            className="absolute top-6 right-6 text-white text-sm border border-white/20 py-2 px-4 hover:bg-white/10 transition-colors cursor-pointer"
          >
            Close
          </button>
        </div>
